...
// Sticky Navigation
// // naive scroll event listener method
...
// // when 0% and 20% of the viewport (the threshold we set) are visable, the callback function will fire
// const obsOptions = {
//   root: null,
//   threshold: [0, 0.2],
// };
...
// rootMargin is a visual margin to make the nav begin in that location
